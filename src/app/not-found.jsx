  ...
  return (
    <Container className="flex h-full items-center pt-20 sm:pt-24 lg:pt-32">
      <FadeIn className="flex flex-col items-center">
        ...
        Oops! Looks like youve wandered off the beaten path. Dont worry, even the best farmers take a wrong turn sometimes. Lets navigate back to the main harvest together.
        </p>
        <Link
          href="/"
